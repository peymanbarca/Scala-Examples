...
//  val command = "get"
//  val url = "https://api.kilid.com/api/location/uri/getNames?locations=c_2301021576-n_230102160126-l_37"
//  val params = parseArgs(args)
  ...
  val testRestClient = RestClient; testRestClient.main(Array("get","https://api.kilid.com/api/location/uri/getNames?locations=c_2301021576-n_230102160126-l_37"))
